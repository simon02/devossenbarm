...
// This page contains a working example of the newsletter sign up and promo popup forms. This PHP code will need to be included in the header of every page. Please note there are form action and button changes for the sign up forms, which will also need to be carried across every page.
...
if($continue===true){
	...
	$message = $_POST['email']. ' wants to subscribe to your mailing list';
                ...
                <div class="news">
                    ...
                    <div class="subscribe">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            ...
                            <button name="subscribe" value="subscribeform"><span data-hover="Sign Up">Sign Up</span></button>
                        </form>
                    </div>
                    <div class="social">
...
<div id="pop">
    ...
    <div class="container">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <input name="email" type="text" placeholder="Your email address" />
            <button name="subscribe" value="subscribeform"><span data-hover="Subscribe">Subscribe</span></button>
        </form>
